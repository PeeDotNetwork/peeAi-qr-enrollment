...
const StickerCampaignInterface = ({ walletAddress, tokenBalance, isEligible }: StickerCampaignInterfaceProps) => {
  ...
  if (!walletAddress) {
    return (
      <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl text-center p-8 shadow-2xl">
        <div className="animate-pulse">
          <div className="w-16 h-16 mx-auto bg-gradient-to-br from-purple-400/30 via-pink-400/30 to-blue-400/30 rounded-full flex items-center justify-center mb-4">
  ...
  return (
    <div className="space-y-4">
      {/* Campaign Header */}
      <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-6 shadow-2xl hover:shadow-purple-500/20 transition-all duration-300">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-6">
            <div className="w-16 h-16 bg-gradient-to-br from-purple-400 via-pink-400 to-blue-400 rounded-full flex items-center justify-center shadow-xl animate-pulse">
        ...
        {showCampaignDetails && (
          <div className="mt-4 p-4 bg-gradient-to-r from-purple-500/10 to-pink-500/10 border border-purple-400/20 rounded-xl backdrop-blur-sm animate-fade-in">
      ...
      <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-6 shadow-2xl hover:shadow-blue-500/20 transition-all duration-300">
        ...
        {showBalanceDetails && (
          ...
          <div className="bg-gradient-to-br from-blue-500/20 to-cyan-500/20 backdrop-blur-sm rounded-xl p-4 border border-blue-400/30 hover:border-blue-400/50 transition-all duration-300">
            <p className="text-sm text-blue-300 mb-2 font-medium">Your Balance</p>
            <p className="text-2xl font-bold text-white">
              {tokenBalance.toLocaleString()} 
              <span className="text-base text-blue-300 ml-1">$peeAI</span>
            </p>
          </div>
          <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 backdrop-blur-sm rounded-xl p-4 border border-purple-400/30 hover:border-purple-400/50 transition-all duration-300">
            <p className="text-sm text-purple-300 mb-2 font-medium">Required</p>
            <p className="text-2xl font-bold text-white">
              {minTokensRequired.toLocaleString()}
              <span className="text-base text-purple-300 ml-1">$peeAI</span>
            </p>
          </div>
          <div className={`bg-gradient-to-br backdrop-blur-sm rounded-xl p-4 border transition-all duration-300 ${
            isEligible 
            ...
            <p className={`text-2xl font-bold ${isEligible ? 'text-green-400' : 'text-red-400'}`}>
              ...
              <span className={`text-base ml-1 ${isEligible ? 'text-green-300' : 'text-red-300'}`}>$peeAI</span>
            </p>
          </div>
        </div>
        )}
        ...
        {!isEligible && (
          <div className="mt-4 p-4 bg-gradient-to-r from-red-500/10 to-pink-500/10 border border-red-400/30 rounded-xl backdrop-blur-sm">
      ...
      {/* Enrollment Form */}
      {isEligible && (
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-6 shadow-2xl hover:shadow-green-500/20 transition-all duration-300">
          ...
          {isEnrolled ? (
            <div className="text-center py-8">
              <div className="w-16 h-16 bg-gradient-to-br from-green-400 to-emerald-400 rounded-full flex items-center justify-center mx-auto mb-4 animate-pulse">
                <CheckCircle className="w-8 h-8 text-white" />
              </div>
              <h3 className="text-2xl font-bold text-green-400 mb-3">Enrollment Successful!</h3>
              <p className="text-white/80 mb-6">
                Thank you for joining the $peeAI sticker campaign! Your exclusive QR stickers will be shipped within 2-3 weeks.
              </p>
              <div className="bg-gradient-to-br from-green-500/20 to-emerald-500/20 border border-green-400/30 rounded-xl p-4 inline-block backdrop-blur-sm">
                <p className="text-sm text-green-300 mb-2 font-medium">Delivery to:</p>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2.5 bg-white/10 border border-white/30 rounded-lg text-white placeholder-white/50 focus:border-purple-400 focus:outline-none focus:ring-2 focus:ring-purple-400/20 transition-all duration-300 backdrop-blur-sm"
              ...
              <div className="pt-3">
                <button
                  ...
                  className="flex items-center space-x-2 text-white/70 hover:text-white transition-colors duration-200 mb-3"
                >
                ...
                {showOptionalFields && (
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2.5 bg-white/10 border border-white/30 rounded-lg text-white placeholder-white/50 focus:border-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-400/20 transition-all duration-300 backdrop-blur-sm"
              ...
              <div className="mt-4 p-4 bg-gradient-to-r from-blue-500/10 to-cyan-500/10 border border-blue-400/30 rounded-xl backdrop-blur-sm">
      ...
      {/* Campaign Stats */}
      <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-6 shadow-2xl hover:shadow-cyan-500/20 transition-all duration-300">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="text-center bg-gradient-to-br from-green-500/20 to-emerald-500/20 border border-green-400/30 rounded-xl p-4 hover:border-green-400/50 transition-all duration-300">
            <p className="text-2xl font-bold text-green-400 mb-1">1,247</p>
            <p className="text-xs text-green-300 font-medium">Enrolled</p>
          </div>
          <div className="text-center bg-gradient-to-br from-blue-500/20 to-cyan-500/20 border border-blue-400/30 rounded-xl p-4 hover:border-blue-400/50 transition-all duration-300">
            <p className="text-2xl font-bold text-blue-400 mb-1">5,000</p>
            <p className="text-xs text-blue-300 font-medium">Total Stickers</p>
          </div>
          <div className="text-center bg-gradient-to-br from-purple-500/20 to-pink-500/20 border border-purple-400/30 rounded-xl p-4 hover:border-purple-400/50 transition-all duration-300">
            <p className="text-2xl font-bold text-purple-400 mb-1">3,753</p>
            <p className="text-xs text-purple-300 font-medium">Remaining</p>
          </div>
          <div className="text-center bg-gradient-to-br from-orange-500/20 to-red-500/20 border border-orange-400/30 rounded-xl p-4 hover:border-orange-400/50 transition-all duration-300">
            <p className="text-2xl font-bold text-orange-400 mb-1">23</p>
            <p className="text-xs text-orange-300 font-medium">Days Left</p>
          </div>
        </div>
      </div>
    </div>
